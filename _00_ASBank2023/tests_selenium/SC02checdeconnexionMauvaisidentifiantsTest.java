...
import java.net.URL;
public class SC02checdeconnexionMauvaisidentifiantsTest {
  ...
  @Test
  public void sC02checdeconnexionMauvaisidentifiants() {
    ...
    assertThat(driver.getTitle(), is("Erreur de Connexion"));
  }
}
